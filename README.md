...
### Distribution de données temporelles sur un trimestre
![lien vers l'image](Figure_01.png)

## Figure 2 Distribution of genetic data
### Distribution de données génétiques
![lien vers l'image](Figure_02.png)

## Figure 3 Correlation coefficient according to 1 continuous variable and 1 discrete variable
### Coefficient de corrélation selon 1 variable continue et 1 variable discrete
![lien vers l'image](Figure_03.png)
...
### Test de puissance pour estimer le nombre d'echantillon necessaire pour obtenir un coefficient de correlation et une p-value significative
![lien vers l'image](Figure_08.png)
...
## Figure 10 
### Coverage of reads from a patient's exome sequencing
